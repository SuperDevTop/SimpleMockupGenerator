; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.23026.0 
	...
	TITLE	F:\Swerve\Libs\zlib1211\zlib-1.2.11\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86259 DB	'invalid block type', 00H
	ORG $+1
$SG86264 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG86276 DB	'too many length or distance symbols', 00H
$SG86280 DB	'invalid code lengths set', 00H
	ORG $+3
$SG86291 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86299 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86302 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86304 DB	'invalid literal/lengths set', 00H
$SG86306 DB	'invalid distances set', 00H
	ORG $+2
$SG86322 DB	'invalid literal/length code', 00H
$SG86334 DB	'invalid distance code', 00H
	ORG $+2
$SG86339 DB	'invalid distance too far back', 00H
	ORG $+2
$SG85873 DB	'1.2.11', 00H
_DATA	ENDS
...
; File f:\swerve\libs\zlib1211\zlib-1.2.11\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85873[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86259
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86264
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86276
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86280
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86291
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86299
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86302
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86304
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86306
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86322
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86334
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86339
