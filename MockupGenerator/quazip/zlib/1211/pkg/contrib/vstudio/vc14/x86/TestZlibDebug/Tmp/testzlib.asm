; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.23026.0 
	...
	TITLE	F:\Swerve\Libs\zlib1211\zlib-1.2.11\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG88888 DB	'rb', 00H
	ORG $+5
$SG88949 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG88952 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG88953 DB	'file %s read, %u bytes', 0aH, 00H
$SG88957 DB	'1.2.11', 00H
	ORG $+1
$SG88958 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG88959 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88960 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88961 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88962 DB	'1.2.11', 00H
	ORG $+1
$SG88963 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG88964 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88965 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88966 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88969 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File f:\swerve\libs\zlib1211\zlib-1.2.11\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
