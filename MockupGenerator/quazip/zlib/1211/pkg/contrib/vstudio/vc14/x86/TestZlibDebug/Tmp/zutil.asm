; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.23026.0 
	...
	TITLE	F:\Swerve\Libs\zlib1211\zlib-1.2.11\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG89386 DB	'need dictionary', 00H
$SG89387 DB	'stream end', 00H
	ORG $+1
$SG89389 DB	'file error', 00H
	ORG $+1
$SG89390 DB	'stream error', 00H
	ORG $+3
$SG89391 DB	'data error', 00H
	ORG $+1
$SG89392 DB	'insufficient memory', 00H
$SG89393 DB	'buffer error', 00H
	ORG $+3
$SG89394 DB	'incompatible version', 00H
	ORG $+3
$SG89397 DB	'1.2.11', 00H
_DATA	ENDS
...
; File f:\swerve\libs\zlib1211\zlib-1.2.11\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
